...
// Images import
import m1 from "../../../assets/solutions/application/vdi_providers.png";
import m2 from "../../../assets/solutions/application/user_experience.jpg";
import m3 from "../../../assets/solutions/application/computers.jpg";
import m4 from "../../../assets/solutions/application/secure_data.jpg";
import m5 from "../../../assets/solutions/application/vdi2.jpg";
      ...
      <div className="bg-[#f5f8fc] mt-16">
        ...
        <div className="relative overflow-hidden py-20 px-6 md:px-12">
          ...
          <div className="relative max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-lg md:text-xl opacity-90 mt-5 leading-relaxed">
              ...
              with flexible, secure, and efficient desktop delivery,
              transforming the way organizations manage and access desktops and
              applications. Our VedaVault (VV) Series servers and workstations,
              proudly made in India, are designed to optimize VDI deployments
        ...
        <section>
          ...
          <section className="max-w-7xl mx-auto px-6 mt-14 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#003c66] leading-snug">
                VDI-Certified &
                <span className="text-[#007cd6]"> Compliant</span>
              </h2>
          ...
          <section className="max-w-7xl mx-auto px-6 mt-28 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-600 mt-5 leading-relaxed text-lg">
                ...
                processors, ample memory, and high-performance storage, ensuring
                a seamless and responsive user experience for virtual desktops
                and applications.
              </p>
            </div>
          ...
          <section className="max-w-7xl mx-auto px-6 mt-28 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-5 leading-relaxed text-lg">
                ...
                the scalability required to accommodate increasing VDI
                workloads. Easily add more nodes to your VDI infrastructure
          ...
          <section className="max-w-7xl mx-auto px-6 mt-28 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 md:order-1">
              ...
              <p className="text-gray-600 mt-5 leading-relaxed text-lg">
                ...
                environments. Our servers are built with robust security
                features, ensuring the confidentiality and integrity of
                sensitive data.
              </p>
            </div>
          ...
          <section className="max-w-7xl mx-auto px-6 mt-24 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-5 leading-relaxed text-lg">
                Kelax VedaVault (VV) Series simplifies desktop management
                through centralised control and streamlined deployment.
                Efficiently deliver and manage virtual desktops, reducing IT
                overhead.
              </p>
            </div>
          </section>
        ...
        "
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                Empower your remote workforce with Kelax VedaVault (VV) Series
                VDI solutions. Enable secure access to corporate resources from
        ...
        "
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Employees can access virtual desktops and applications from
                their personal devices while maintaining data security.
              </p>
            </div>
        ...
        "
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                For content creators and multimedia professionals, Kelax
                VedaVault (VV) Series delivers the performance needed to handle
        ...
        <div className="relative mt-12 max-w-6xl mx-auto overflow-hidden px-6 md:px-1 mb-8">
          ...
          <p className="text-gray-700 text-lg md:text-xl mt-4 leading-relaxed">
            Unlock the full potential of Virtual Desktop Infrastructure with
            Kelax VedaVault (VV) Series. Our VDI-certified servers provide the
            ...
            Desktop Infrastructure (VDI) Solutions today. Reach out to our
            experts to explore how our VedaVault (VV) Series can revolutionise
            your desktop management, enhance productivity, and empower your
            workforce. Experience the difference of VDI with Kelax.
          </p>
        </div>
      </div>
      <Footer />
